...
declare module '$env/static/private' {
	...
	export const npm_package_scripts_back_dev: string;
	...
	export const npm_package_devDependencies__types_joi: string;
	...
	export const npm_package_devDependencies_ts_node_dev: string;
	export const npm_package_devDependencies_jest_mock_extended: string;
	...
	export const npm_package_devDependencies__smui_card: string;
	export const SSH_AGENT_LAUNCHER: string;
	export const SSH_AUTH_SOCK: string;
	export const ORIGINAL_XDG_CURRENT_DESKTOP: string;
	export const npm_package_scripts_test: string;
	export const npm_package_devDependencies__trivago_prettier_plugin_sort_imports: string;
	export const npm_config_version_git_message: string;
	export const npm_package_devDependencies__sveltejs_kit: string;
	export const npm_package_scripts_smui_theme: string;
	...
	export const npm_package_dependencies_shallow_equal_object: string;
	...
	export const npm_package_dependencies__types_nodemailer: string;
	...
	export const npm_package_devDependencies__smui_textfield: string;
	export const npm_package_devDependencies__smui_form_field: string;
}
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_scripts_back_dev: string;
		...
		npm_package_devDependencies__types_joi: string;
		...
		npm_package_devDependencies_ts_node_dev: string;
		npm_package_devDependencies_jest_mock_extended: string;
		XMODIFIERS: string;
		...
		npm_package_devDependencies__smui_card: string;
		SSH_AGENT_LAUNCHER: string;
		SSH_AUTH_SOCK: string;
		ORIGINAL_XDG_CURRENT_DESKTOP: string;
		npm_package_scripts_test: string;
		npm_package_devDependencies__trivago_prettier_plugin_sort_imports: string;
		npm_config_version_git_message: string;
		npm_package_devDependencies__sveltejs_kit: string;
		npm_package_scripts_smui_theme: string;
		SHELL: string;
		...
		P9K_SSH: string;
		npm_package_dependencies_shallow_equal_object: string;
		...
		ZDOTDIR: string;
		npm_package_dependencies__types_nodemailer: string;
		...
		INIT_CWD: string;
		npm_package_devDependencies__smui_textfield: string;
		npm_package_devDependencies__smui_form_field: string;
